...
'''goal: 1, extract the data
         2, function of splitting data into training, dev, test set
         3, test with lstm
...
def mean_median(numbers):
    return round(mean([mean(numbers), median(numbers)]),2)
